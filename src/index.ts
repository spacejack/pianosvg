...
function PianoSVG (opts?: PianoSVG.Options): PianoSVG {
	const options: PianoSVG.Options = {...opts}
...
namespace PianoSVG {
	export type KeyState = 0 | 1 | 2 | undefined

	export const KEYSTATE_NOKEY = 0
	export const KEYSTATE_OFF = 1
	export const KEYSTATE_ON = 2
